        ...
        given()
            ...
            .then()
                ...
                .body("size", Matchers.equalTo(5),
                        ...
                        "content[0].restaurantId", Matchers.equalTo("5093fdf4-04fb-46ae-adb7-88848a2a978a"),
                        "content[0].average", Matchers.equalTo(3.2f),
                        "content[0].qtdReview", Matchers.equalTo(20),
                        "content[1].restaurantId", Matchers.equalTo("1ea36074-5880-4710-8943-d1ccb8ca6a18"),
                        "content[1].average", Matchers.equalTo(3.1f),
                        "content[1].qtdReview", Matchers.equalTo(19),
                        "content[2].restaurantId", Matchers.equalTo("cc2c3338-efe2-42f1-b424-76fb0ac2f624"),
                        "content[2].average", Matchers.equalTo(3.0f),
                        "content[2].qtdReview", Matchers.equalTo(22),
                        "content[3].restaurantId", Matchers.equalTo("3e8b1069-9241-4695-a901-e805a05633a9"),
                        "content[3].average", Matchers.equalTo(2.8f),
                        "content[3].qtdReview", Matchers.equalTo(18),
                        "content[4].restaurantId", Matchers.equalTo("edec1033-95ff-4e74-8fd1-c37114b32ea1"),
